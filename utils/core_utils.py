...
def find_func(model_name: str):
    ...
    if model_name in ['mean_mil', 'max_mil', 'att_mil','trans_mil', 's4model','mamba_mil','dualpath_mamba_mil']:
...
def train(datasets, cur, args):
    ...
    elif args.model_type == 'dualpath_mamba_mil':
        from models.DualPathMamMIL import DualPathMambaMIL
